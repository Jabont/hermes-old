	...
	<main>
		<section>
			<div class="cont-pd">
				...
				<h1 class="upper underline bd-ci1">Enrolled</h1>
				<theboxes boxing="2" mob="2" class=" spacing-l -gap lack">
				<?php
				$conn = conn();
				$sql = "SELECT class_main.id, class_main.name, class_main.description, class_main.cover_url, user.username FROM class_main INNER JOIN class_enrollment WHERE class_main.owner_id = user.id ORDER BY class_main.id";
