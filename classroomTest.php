...
<body>
			...
			<div class="col-2" id="sidebar">
				<nav class="nav flex-column center">
					<div class="row">
						...
						<div class="col-6 icon"><a class="nav-link" href="#">Time</a></div>
					</div>
	...
	<div class="text">
		<h4 style="color: #A2A2A2">Classroom by</h4>
		<h1 style="color: #FFCF40; size: ">AIRMES</h1>
	</div>
	<br>
	<div onclick="window.location.href='index.php'">
		<h5 class="box" style="color: white;">เข้าสู่คอร์สเรียน</h5>
	</div>
</body>
</html>
